...
import edu.cg.scene.objects.Triangle;
...
public class Scenes {
	...
	public static Scene scene8() {
		...
		Shape sphereShape8 = new Sphere()
				.initCenter(new Point(-0.7, -0.7, -2))
				.initRadius(0.5);
		Material sphereMat1 = new Material()
				.initKa(new Vec(1))
				.initKd1(new Vec(1, 1, 0))	
				.initKs(new Vec(0.7))
				.initReflectionIntensity(0.95)
				.initShininess(10);
		Surface sphereSurface8 = new Surface(sphereShape8, sphereMat1);
	...
	public static Scene scene9() {
		...
		Shape plainShape1 = new Plain(1, 0, -0.1, -3);		//right
		Material plainMat1 = new Material()
				.initKa(new Vec(1))
				.initKd1(new Vec(0.6, 0, 0.8))
				.initKd2(new Vec(0.3, 0, 0.4))
		...
		Shape plainShape2 = new Plain(0, 0, -1, -3.5);		//forward
		Material plainMat2 = new Material()
				.initKa(new Vec(1))
				.initKd1(new Vec(0.7, 0.7, 0))
				.initKd2(new Vec(0.35, 0.35, 0))
		...
		Shape plainShape3 = new Plain(-1, 0, -0.1, -3);		//left
		Material plainMat3 = new Material()
				.initKa(new Vec(1))
				.initKd1(new Vec(0, 0.9, 0.5))
				.initKd2(new Vec(0, 0.45, 0.25))
		...
		Shape plainShape4 = new Plain(0, 1, -0.1, -3);	//up	
		Material plainMat4 = new Material()
				.initKa(new Vec(1))
				.initKd1(new Vec(0, 0.8, 0.8))
				.initKd2(new Vec(0, 0.4, 0.4))
		...
		Shape plainShape5 = new Plain(0, -1, -0.1, -3);		//down
		Material plainMat5 = new Material()
				.initKa(new Vec(1))
				.initKd1(new Vec(0.9, 0, 0.1))
				.initKd2(new Vec(0.45, 0, 0.05))
	...
	public static Scene scene11() {
		Point p1 = new Point(-0.7, -0.7, -2);
		Point p2 = new Point(0, -0.7, -2);
		Point p3 = new Point( -0.7, 0, -2);
	
		Shape triangleShape = new Triangle(p1,p2,p3);
